...
You likely chose option 2, but why? Code fundamentally serves to communicate instructions to machines, so if it does so in a correct manner, why is one better than another?
