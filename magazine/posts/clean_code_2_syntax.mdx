...
So one might think, following this set of conventions will lead one to write clean code. Clean code, sadly and luckily for our jobs, can't be generated from a set of rules, it extends far beyond the scope of rules to the realm of art.
