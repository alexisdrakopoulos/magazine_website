...
|                         | Convention                           | Example       |
| ----------------------- | ------------------------------------ | ------------- |
| **Variables**           | lower case, words separated by a `_` | `my_variable` |
| **Constants**           | UPPER CASE, words separated by a `_` | `MY_CONSTANT` |
| **Functions & Methods** | lower case, words separated by a `_` | `my_function` |
